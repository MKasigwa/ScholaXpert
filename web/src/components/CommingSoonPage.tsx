...
import { useWaitlistSubscribe, buildSubscribeData } from "@/hooks/useWaitlist";
import { toast } from "sonner";
import {
  GraduationCap,
  Users,
...
export function ComingSoonPage() {
  ...
  const [email, setEmail] = useState("");
  const { subscribe, isLoading, isSubmitted } = useWaitlistSubscribe();
  const [timeLeft, setTimeLeft] = useState<TimeLeft>({
    days: 45,
    hours: 12,
    minutes: 30,
        ...
        <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden border-4 border-border shadow-2xl">
                <Image
                  src="https://images.unsplash.com/photo-1528249072419-472a928b71c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBzY2hvb2wlMjBzdHVkZW50cyUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzU5OTIxNjcxfDA&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Modern school technology"
                  width={1080}
                  height={720}
                  className="w-full h-auto"
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                image:
                  "https://images.unsplash.com/photo-1542725752-e9f7259b3881?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb24lMjBsZWFybmluZyUyMGJvb2tzfGVufDF8fHx8MTc1OTg3MDE4OXww&ixlib=rb-4.1.0&q=80&w=1080",
                title: t("highlights.comprehensiveModules.title"),
                description: t("highlights.comprehensiveModules.description"),
              },
              {
                image:
                  "https://images.unsplash.com/photo-1758270704534-fd9715bffc0e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbGFzc3Jvb20lMjBkaWdpdGFsJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NTk5MjE2NzJ8MA&ixlib=rb-4.1.0&q=80&w=1080",
                title: t("highlights.modernTechnology.title"),
                description: t("highlights.modernTechnology.description"),
              },
              {
                image:
                  "https://images.unsplash.com/photo-1528249072419-472a928b71c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBzY2hvb2wlMjBzdHVkZW50cyUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzU5OTIxNjcxfDA&ixlib=rb-4.1.0&q=80&w=1080",
                title: t("highlights.userCentricDesign.title"),
                description: t("highlights.userCentricDesign.description"),
              },
            ].map((item, index) => (
